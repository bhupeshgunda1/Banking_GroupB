	...
	<div class="container">
		...
		<div class="navbar">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="adminhome">Add customer</a>
					<a href="adminhome">Update customer</a>
					<a href="adminhome">Delete customer</a>
				</div>
			</div>
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="adminhome">Update Transaction</a>
		...
		<br />
		<div>
		<h1 style="color:navy;font-size:40px;">ONLINE BANKING - ADMIN</h1> <br>
		<div align="right">
