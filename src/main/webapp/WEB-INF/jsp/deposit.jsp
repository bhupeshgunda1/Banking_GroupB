	...
	<div class="container">
		...
		<div>
			...
			<div align="center">
				...
				<form:input path="Balance" required="required" placeholder="Enter amount"/> <br>
			    <input type="submit" value="depositAmount"/> <br> <br>
			         
				</form:form>
				
				<h1>Updated Account Balance : ${param.updatedbalance}</h1>
			</div>
