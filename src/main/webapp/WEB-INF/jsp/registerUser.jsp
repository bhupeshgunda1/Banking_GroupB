...
<body>
	...
	<form:form method="post" action="addusersave">			
		...
		<br><br>
		<!--  	<form:input type="password" path="confirmpassword" required="required"  placeholder="CONFIRM PASSWORD"/>
		<br><br>
			<form:input path="email" required="required"  placeholder="EMAIL" />
		<br><br>
			<form:input path="phone" required="required"  placeholder="PHONE NUMBER"/>
		<br><br>
		-->
