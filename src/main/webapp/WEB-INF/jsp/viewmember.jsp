		...
		<table align="center" width="90%" cellpadding="2">
			...
			<c:forEach var="member" items="${list}">
				<tr bgcolor="#ffcccc">
					...
					<td>${member.membtype}</td>
					<td>${member.membdate}</td>
					<td>${member.expdate}</td>
					<td>${member.loginid}</td>
					<td><a href="editmember/${member.membid}">Edit</a></td>
					<td><a href="deletemember/${member.membid}">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		<br /> <a href="memberform">Add New Member</a>
	</div>
