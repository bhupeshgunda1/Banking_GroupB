...
<body>
	...
	<div class="container">
		...
		<form:form method="post" action="/Assignment4_Group_B/membersave">
			<table class="containerCenter" width="40%">
				<tr>
					<td>Name :</td>
				...
				<tr>
					...
					<td><form:input path="membtype" /></td>
				</tr>
				<tr>
					<td>Membership Date:</td>
					<td><form:input type="date" path="membdate" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td></td>
					<td><input type="submit" value="Register Member" /></td>
				</tr>
			</table>
		</form:form>
