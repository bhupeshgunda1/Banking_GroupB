		...
		<table align="center" border="2" width="20%" cellpadding="3">
			...
			<c:forEach var="publisher" items="${list}">
				<tr bgcolor="#f5f50f">
					...
					<td><a href="editpublisher/${publisher.publisherid}">Edit</a></td>
					<td><a href="deletepublisher/${publisher.publisherid}">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
		<br /> <a href="publisherform">Add New Publisher</a> <br /> <br />
	</div>
